    ...
    .directive("skinChanger", ["$rootScope", "$filter","$state", "$stateParams", function ($rootScope, $filter, $state, $stateParams) {
        return {
            ...
            link: function (scope, el, attr) {
                ...
                scope.skins = [
                    {
                        skin: "Content/themes/beyond/skins/blue.min.css",
                        color: {
                            themeprimary: "#5db2ff",
                    ...
                    {
                        skin: "Content/themes/beyond/skins/azure.min.css",
                        color: {
                            themeprimary: "#2dc3e8",
                    ...
                    {
                        skin: "Content/themes/beyond/skins/black.min.css",
                        color: {
                            themeprimary: "#474544",
                    ...
                    {
                        skin: "Content/themes/beyond/skins/darkblue.min.css",
                        color: {
                            themeprimary: "#0072c6",
                            themesecondary: "#fb6e52",
                            themethirdcolor: "#ffce55",
                    ...
                    {
                        skin: "Content/themes/beyond/skins/darkred.min.css",
                        color: {
                            themeprimary: "#ac193d",
                    ...
                    {
                        skin: "Content/themes/beyond/skins/deepblue.min.css",
                        color: {
                            themeprimary: "#001940",
                            themesecondary: "#d73d32",
                            themethirdcolor: "#ffce55",
                    ...
                    {
                        skin: "Content/themes/beyond/skins/gray.min.css",
                        color: {
                            themeprimary: "#585858",
                            themesecondary: "#fb6e52",
                            themethirdcolor: "#ffce55",
                    ...
                    {
                        skin: "Content/themes/beyond/skins/green.min.css",
                        color: {
                            themeprimary: "#53a93f",
                            themesecondary: "#ed4e2a",
                            themethirdcolor: "#ffce55",
                    ...
                    {
                        skin: "Content/themes/beyond/skins/orange.min.css",
                        color: {
                            themeprimary: "#ff8f32",
                            themesecondary: "#7bd148",
                            themethirdcolor: "#5db2ff",
                    ...
                    {
                        skin: "Content/themes/beyond/skins/pink.min.css",
                        color: {
                            themeprimary: "#cc324b",
                    ...
                    {
                        skin: "Content/themes/beyond/skins/purple.min.css",
                        color: {
                            themeprimary: "#8c0095",
                    ...
                    {
                        skin: "Content/themes/beyond/skins/teal.min.css",
                        color: {
                            themeprimary: "#03b3b2",
                            themesecondary: "#ed4e2a",
                            themethirdcolor: "#ffce55",
